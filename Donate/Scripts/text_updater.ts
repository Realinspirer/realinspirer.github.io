...
consoleText(
    [
        ...
        {text:"Support a programmer", font_size:0.75}], 'title_text');

function consoleText(words:Array<text_and_font>, id:string) {
  var letterCount = 1;
  var x = 1;
  var waiting = false;
...
function set_target_font(target:HTMLElement, size:number|null|undefined){
        if(size != null){
